<%-- 
    Document   : Respins
    Created on : Jun 28, 2013, 6:02:33 AM
    Author     : George
--%>
...
<html>
    ...
    <body>
        ...
        <div id="cssmenu">
            ...
            <h2 id="art">Introduceti motivul respingerii:</h2>
            <form action="Rejected.jsp">
                <table>
                <tr>
                    <%
                    int id = Integer.parseInt(request.getParameter("idpackage"));
                    %>
                    <td>ID-ul coletului:</td><td><input type="text" name="id" value='<%=id%>'></td>
                </tr>
                <tr>
                <td>Motivul:</td><td><input type="text" name="motiv"></td>
                </tr>
                </table>
                <input type="submit" value="Afiseaza Raport">
            </form>
    </center>
    </body>
</html>
