<%-- 
    Document   : AdaugareCamion
    Created on : Jun 23, 2013, 4:46:24 PM
    Author     : George
--%>
...
<html>
    ...
    <body>
        ...
        <div id="cssmenu">
            ...
            <form action="AddCamion.jsp">
                <table>
                <tr>
                <td>Numar inmatriculare:</td><td><input type="text" name="numar"></td>
                </tr>
                <tr>
